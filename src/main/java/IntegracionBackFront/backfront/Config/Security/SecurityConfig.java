...
@Configuration
/*Esto es importante*/
/*Esto permite que solo ciertos sitios la puedan llamar(que tengan acceso por el token si no pos no) */
@EnableWebSecurity
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                /*Estos endpoints no necesitan autenticacion*/
                ...
                .authorizeHttpRequests(auth -> auth  // Cambia authorizeRequests por authorizeHttpRequests
                        .requestMatchers(HttpMethod.POST,
                                ...
                                "/api/auth/logout")
                        .permitAll()
                        /*Estos son los que necesitan autenticacion*/
